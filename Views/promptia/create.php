...
<div class="container">
    <h1>Créer un nouveau promptia</h1>

    <form method="post" action="<?= site_url('promptia/create') ?>" class="p-3">
        <div class="form-group">
            <label for="activites">Activités:</label>
            <input type="text" name="activites" id="activites" class="form-control" required>
        </div>

        <div class="form-group">
            <label for="taches">Tâches:</label>
            <input type="text" name="taches" id="taches" class="form-control" required>
        </div>

        <div class="form-group">
            <label for="outils">Outils:</label>
            <input type="text" name="outils" id="outils" class="form-control" required>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea name="actions" id="actions" class="form-control" required></textarea>
        </div>
